...
const DesktopFilter = () => {
  ...
  return (
    <>
      <div className="1330px:w-[1298px] hidden md:block z-20 relative w-[1018px] mx-auto xl:w-[890px] lg:w-[820px] md:w-[740px] 400px:w-[349px] 600px:w-[537px] 300px:w-[301px]">
        <div className="flex items-center gap-2 mb-3">
          ...
          <p className="text-[14px] text-[#0074DF]">Filter</p>
        </div>
